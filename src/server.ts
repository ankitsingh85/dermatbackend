...
import clinicLoginRoutes from "./routes/clinicloginRoutes";
...
import offer1Routes from "./routes/offer1Routes";
import offer2Routes from "./routes/offer2Routes";
import offer3Routes from "./routes/offer3Routes";
import offer4Routes from "./routes/offer4Routes";
...
server.use("/api/clinic-auth", clinicLoginRoutes);
...
server.use("/api/offer4", offer4Routes);
